[![GPL 3.0](https://img.shields.io/github/license/AeoliaXYZ/AeoliaLib?&logo=github&label=License)](LICENSE)
...
## Dependencies
This plugin depends Essentials and [KotKit](https://github.com/AeoliaXYZ/KotKit/tree/master).

It also softdepends LuckPerms and Vault. Without these plugins, most features of this plugin will not be available.
